    ...
    <div id="" class="carrito-container container-fluid w-correccionMegustas my-5">
        ...
        @foreach($productos as $producto)
            <div class="row border align-items-center pt-2 pb-2" id="{{$producto->id_producto  }}">
                <div class="col-3 text-center">{{ $producto->nombre_producto }}</div>
                <div class="col-3 text-center d-flex justify-content-center align-items-center gap-2">{{ $producto->stock_producto }}</div>
                <div class="col-3 text-center precio-producto">${{ $producto->precio_producto }}</div>
        ...
        <div class=" pt-4 d-flex justify-content-center align-items-center ">
            <a href="" class="btn btn-primary btn_form">Agregar producto</a>
        </div>
